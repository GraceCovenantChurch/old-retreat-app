...
echo <<< EOF
      ...
      sermons</a> so that new sermons <br>are automatically
      downloaded to your iPod.</p><br clear="left"><br>
      <p class="medium">$swap_type
      are also available to download.</p>
EOF;
?>

      <table width="532 border="0" cellspacing="3" cellpadding="0" class="text">
...
EOF;
	...
	<tr align="center" class="text"> 
	  ...
	  <td width="120" height="4" bgcolor="#CCCCCC"><b>Scripture</b></td>
...
EOF;
	...
	echo <<<EOF
                          <tr align="center" class="text"> 
                            <td height=28 bgcolor="#F0F0F0" class="text"><strong><font class="$type" size=1>$type</font></strong></td>
                            <td height=28 bgcolor="#F0F0F0" class="text"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">$date</font></td>
                            <td height="28" bgcolor="#F0F0F0" class="text"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">$title<br>
EOF;
