...
if ($deposit < $price) {
    ...
    if ($deposit == 0) {
      $depositStr = "<a href='https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal%40gracecovenant%2enet&item_name=GCC%20College%20Retreat%202015&amount=40%2e00&no_shipping=0&custom=$email_esc&invoice=a2015_deposit_$id&return=http%3a%2f%2fuc%2egracecovenant%2enet%2fretreat%2fpayment_success%2ephp&cancel_return=http%3a%2f%2fuc%2egracecovenant%2enet%2fretreat%2fpayment_failure%2ephp&no_note=1&currency_code=USD&lc=US&bn=PP%2dBuyNowBF&charset=UTF%2d8'>pay the \$40 deposit by PayPal</a> or ";
    } else {
      $depositStr = ""; 
    }
 
    echo "Please $depositStr <a href='https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal%40gracecovenant%2enet&item_name=GCC%20College%20Retreat%202015&amount=$balance%2e00&no_shipping=0&custom=$email_esc&invoice=a2015_$id&return=http%3a%2f%2fuc%2egracecovenant%2enet%2fretreat%2fpayment_success%2ephp&cancel_return=http%3a%2f%2fuc%2egracecovenant%2enet%2fretreat%2fpayment_failure%2ephp&no_note=1&currency_code=USD&lc=US&bn=PP%2dBuyNowBF&charset=UTF%2d8'>pay \$$balance by PayPal</a> as soon as possible.\n";
}
?>
  </td>
 </tr>
