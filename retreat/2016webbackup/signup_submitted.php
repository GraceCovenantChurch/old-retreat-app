...
include_once("db_connect.php");
  ...
  if (!$result) {
    ...
    if (strncmp($err, "Duplicate entry ", strlen("Duplicate entry "))==0) {
      echo "<p>Someone has already registered for GCC College Retreat 2016 using this email address ($email).  If you need to change any of your information, please contact <a href='mailto:retreatstaff@gracecovenant.net'>retreatstaff@gracecovenant.net</a>";
    } else {
  ...
  if (!$err) {
      // SEND EMAIL
      echo "You have successfully registered for GCC College Retreat 2016!\n";
      ...
      $mail_subj = "Registration for GCC College Retreat 2016";
      $name = $_POST['fname'] .' '. $_POST['lname'];
      $headers = <<<EOF
From: GCC College Retreat 2016 Registration <retreatstaff@gracecovenant.net>
MIME-Version: 1.0
...
<HTML>
 ...
 <body>
  ...
  <p>We're glad to hear you'll be attending GCC College Retreat 2016.
...
EOF;
     ...
     if($fg_flag) {
      ...
      echo $explanation;
        ...
        echo "<p class='noticeMe'>Please pay the \$40 deposit or the full \$$price through PayPal.   Your cost will be based on when you pay, not when you sign up, so please pay as soon as possible. \n";
        $email = $_POST['email'];
        echo <<<EOF
	<p class='noticeMe'><u>Pay the \$40 deposit:</u></p>
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        <input type="hidden" name="cmd" value="_xclick">
        <input type="hidden" name="business" value="paypal@gracecovenant.net">
        <input type="hidden" name="item_name" value="GCC College Retreat 2016">
        <input type="hidden" name="amount" value="40.00">
        <input type="hidden" name="no_shipping" value="1">
        <input type="hidden" name="custom" value="$email">
        <input type="hidden" name="invoice" value="a2016_deposit_$id">
	...
	<p class='noticeMe'><u>Pay the full \$$price:</u></p>
        ...
        <input type="hidden" name="no_shipping" value="1">
        <input type="hidden" name="custom" value="$email">
        <input type="hidden" name="invoice" value="a2016_$id">
        <input type="hidden" name="return" value="http://www.uc.gracecovenant.net/retreat/payment_success.php">
        <input type="hidden" name="cancel_return" value="http://www.uc.gracecovenant.net/retreat/payment_failure.php">
        <input type="hidden" name="no_note" value="1">
        <input type="hidden" name="currency_code" value="USD">
