...
<table width="556" cellspacing="0" cellpadding="2">
 ...
 <td><table>
    ...
    <tr><td><img id="sun" name="sun" src="./images/ugandabanner.jpg" border="0" onclick="redirect()"></td></tr>
    <tr><td>
 ...
 <td><table>
    <tr><td>
        <?php
                start_subbox(212,'orange','missions','right','left','');
                echo "<p class='missions'>Click <a href='./ministries/missions/summer08/uganda.php'>here</a> for the Uganda missions team home page (Updated 7/26).</p>
		      <p class='missions'>Click <a href='./ministries/missions/summer08/otr.php'>here</a> for the Over the Rhine missions team home page (Updated 7/24).</p>";
        end_subbox('orange','');
        ?>
    </td></tr>
    <tr><td>
