...
<div id="imagediv" style="position: relative;">
	<img name="bigpic" src="./testimages/blank.jpg" width="500px" height="335px" border="0" alt="" onclick='redirect();' />
        <div id="captionbox" style="position: absolute; bottom: 0px; left:0; width:500px;">
	  <div id="captionboxbg" style="height:40px;"></div>
        </div>
        <div style="color: white; background-color: none; position: absolute; bottom: 0px; left:10px; width:500px;" id="captioningtextbg">
          <div style="height:30px; font-weight: bold;" id="captioningtext"></div>
        </div>
...
while($i<6){
  echo "<td width='16%'><img src='testimages/blank.jpg'></td>";
  $i++;
}
